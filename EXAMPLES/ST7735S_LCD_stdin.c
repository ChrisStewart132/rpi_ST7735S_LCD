 ...
 * Date: 06062024
 * Description: program to display a 128x160 16bit rgb (565) from stdin on a ST7735S 1.8" 128x160 LCD
 * 
 * gcc -o ST7735S_LCD_stdin ST7735S_LCD_stdin.c -lgpiod
 * cat 16bit_rgb_128_160.bin | ./ST7735S_LCD_stdin
 */
